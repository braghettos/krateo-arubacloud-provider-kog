---
type: Architecture
title: Aruba Cloud Database (DBaaS) provider
description: Database (DBaaS) provider reference — every resource, its verbs, identifiers and uncovered endpoints. Generated.
